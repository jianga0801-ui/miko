...
- PR #13942: https://github.com/anomalyco/miko/pull/13942

## Do Not Translate (Locale Additions)

- `Miko` (preserve casing in prose; keep `miko` only when it is part of commands, package names, paths, or code)
- `Miko Zen`
- `Miko CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `miko` in prose when referring to the product name; use `Miko`
