...
Use this folder for locale-specific translation guidance that supplements `.miko/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/miko/pull/12345

## Do Not Translate (Locale Additions)

- `Miko` (preserve casing)
