...
- PR #15835: https://github.com/anomalyco/miko/pull/15835

## Do Not Translate (Locale Additions)

- `Miko` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `miko` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Miko` in prose, `miko` only for exact technical identifiers
...
- Avoid changing `miko` to `Miko` inside commands, URLs, package names, or code literals
