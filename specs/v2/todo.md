...
The miko server has moved to the Effect HttpApi backend. Remaining work is
...
- plugins get global "miko" instance like in that post i showed
- miko instance has stuff like `miko.session.prompt()` or
  `miko.tool.register({...})`
