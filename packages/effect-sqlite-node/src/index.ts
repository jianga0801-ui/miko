...
export const TypeId: TypeId = "~@miko-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@miko-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@miko-ai/effect-sqlite-node/NodeSqliteClient")
