import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@miko-ai/sdk/v2"
import { SessionTurn } from "@miko-ai/ui/session-turn"
import { SessionReview } from "@miko-ai/ui/session-review"
import { DataProvider } from "@miko-ai/ui/context"
import { FileComponentProvider } from "@miko-ai/ui/context/file"
import { WorkerPoolProvider } from "@miko-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@miko-ai/ui/logo"
import { IconButton } from "@miko-ai/ui/icon-button"
import { ProviderIcon } from "@miko-ai/ui/provider-icon"
import { iife } from "@miko-ai/core/util/iife"
import { Binary } from "@miko-ai/core/util/binary"
import { NamedError } from "@miko-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@miko-ai/ui/tabs"
import { MessageNav } from "@miko-ai/ui/message-nav"
import { FileSSR } from "@miko-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@miko-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/miko-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Miko</Title>
              </Show>
              <Meta name="description" content="miko - The AI coding agent built for the terminal." />
