...
class Database extends Context.Service<Database, DatabaseShape>()("@miko/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@miko/example/UserStore") {
