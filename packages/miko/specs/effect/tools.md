...
Practical reference for the current tool-migration state in `packages/miko`.
...
Tool tests should use the existing Effect helpers in `packages/miko/test/lib/effect.ts`:
