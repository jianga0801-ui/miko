import type * as SDK from "@miko-ai/sdk/v2"
...
import { SessionShareTable } from "@miko-ai/core/share/sql"
import { ProviderV2 } from "@miko-ai/core/provider"
import { EventV2 } from "@miko-ai/core/event"

const log = Log.create({ service: "share-next" })
const disabled = process.env["MIKO_DISABLE_SHARE"] === "true" || process.env["MIKO_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@miko/ShareNext") {}
