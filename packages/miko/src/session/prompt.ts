...
import * as EffectLogger from "@miko-ai/core/effect/logger"
...
import { SessionEvent } from "@miko-ai/core/session/event"
import { ModelV2 } from "@miko-ai/core/model"
import { ProviderV2 } from "@miko-ai/core/provider"
import { AgentAttachment, FileAttachment, ReferenceAttachment, Source } from "@miko-ai/core/session/prompt"
...
import { LLMEvent } from "@miko-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@miko/SessionPrompt") {}
        ...
        while (true) {
          ...
          const outcome: "break" | "continue" = yield* Effect.gen(function* () {
            ...
            const [skills, env, instructions, modelMsgs] = yield* Effect.all([
              ...
              MessageV2.toModelMessagesEffect(msgs, model, { stripStaleMedia: isMimoProviderID(model.providerID) }),
            ])
