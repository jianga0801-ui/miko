...
import type { LLMEvent } from "@miko-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@miko-ai/llm/route"
import type { LLMClientService } from "@miko-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@miko/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via miko's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @miko-ai/llm. It
