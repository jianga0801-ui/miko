import { Slug } from "@miko-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@miko-ai/llm"
...
import { SessionV2 } from "@miko-ai/core/session"
...
import { PartTable, SessionTable } from "@miko-ai/core/session/sql"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@miko-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".miko", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@miko/Session") {}
