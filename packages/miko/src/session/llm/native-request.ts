import type { JsonSchema, LLMRequest, ProviderMetadata } from "@miko-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@miko-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @miko-ai/llm request objects from miko's session/AI SDK-shaped data.
  return LLM.request({
