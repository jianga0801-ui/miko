import type { AuthOAuthResult, Hooks } from "@miko-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@miko/ProviderAuth") {}
        ...
        return {
          hooks: Record.fromEntries(
            Arr.filterMap(plugins, (x) =>
              x.auth?.provider !== undefined && isMimoProviderID(x.auth.provider)
