 ...
 *   "@miko/ServerAuthConfig",
 *   {
 *     password: Config.string("MIKO_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("MIKO_SERVER_USERNAME").pipe(Config.withDefault("miko")),
 *   },
 * ) {}
 *
