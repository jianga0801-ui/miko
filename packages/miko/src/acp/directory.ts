...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@miko/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@miko/ACPDirectory") {}
