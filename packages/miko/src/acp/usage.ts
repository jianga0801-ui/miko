...
import type { AssistantMessage as MikoAssistantMessage, Message } from "@miko-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<MikoAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<MikoAssistantMessage, "role"> &
  Partial<Pick<MikoAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@miko/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@miko/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@miko/ACPUsage") {}
