...
export class Service extends Context.Service<Service, Interface>()("@miko/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __MIKO_PHOTON_WASM_PATH?: string }).__MIKO_PHOTON_WASM_PATH =
