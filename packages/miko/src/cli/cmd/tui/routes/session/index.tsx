...
const GO_UPSELL_PROVIDERS = new Set(["miko", "miko-go"])
      ...
      <Show when={text()}>
        ...
        >
          ...
          >
            ...
            >
              <text fg={theme.textMuted}>
                <span style={{ bg: color(), fg: queuedFg(), bold: true }}> {i18n.t("session.queued")} </span>
              </text>
            </Show>
          </box>
        </box>
    ...
    <>
      ...
      <Show when={props.parts.some((x) => x.type === "tool" && x.tool === "task")}>
        <box paddingTop={1} paddingLeft={3}>
          <text fg={theme.text}>
            {childShortcut()}
            <span style={{ fg: theme.textMuted }}>{i18n.t("session.viewSubagents")}</span>
          </text>
        </box>
      </Show>
