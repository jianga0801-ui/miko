...
} from "@miko-ai/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@miko-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@miko-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@miko-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@miko-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@miko-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@miko-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "miko"
const DEFAULT_PACK_ID = "miko.default"
