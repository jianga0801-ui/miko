...
export const Definitions = {
  ...
  permission_toggle: keybind("tab", "Toggle Auto-Approve permission mode"),
  ...
  prompt_voice_toggle: keybind("alt+v", "Start or stop voice prompt recording"),
  prompt_voice_cancel: keybind("escape", "Cancel voice prompt recording"),
...
export const CommandMap = {
  ...
  prompt_voice_cancel: "prompt.voice.cancel",
