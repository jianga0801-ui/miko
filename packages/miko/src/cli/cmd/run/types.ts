...
import type { MikoClient, PermissionRequest, QuestionRequest, ToolPart } from "@miko-ai/sdk/v2"
...
type PromptModel = Parameters<MikoClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<MikoClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<MikoClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<MikoClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<MikoClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<MikoClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<MikoClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<MikoClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<MikoClient["question"]["reject"]>[0]
