...
import { type Plugin, type ToolContext, tool } from "@miko-ai/plugin"
import type { Event, Message, Part, TextPart } from "@miko-ai/sdk"
...
const BackgroundAgentsPlugin: Plugin = async (ctx) => {
	...
	const baseDir = path.join(os.homedir(), ".local", "share", "miko", "delegations", projectId)
...
export default { id: "background-agents", server: BackgroundAgentsPluginWithInternals }
