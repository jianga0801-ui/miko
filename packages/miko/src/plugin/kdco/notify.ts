...
async function loadConfig(): Promise<NotifyConfig> {
	const configPath = path.join(os.homedir(), ".config", "miko", "kdco-notify.json")
...
const CMUX_SESSION_STATUS_KEY_PREFIX = "miko.session"
...
export default { id: "notify", server: NotifyPlugin }
