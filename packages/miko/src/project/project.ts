...
export class Service extends Context.Service<Service, Interface>()("@miko/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.MIKO_FAKE_VCS)
