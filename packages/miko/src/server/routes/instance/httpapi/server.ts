...
import * as Observability from "@miko-ai/core/effect/observability"
...
import { memoMap } from "@miko-ai/core/effect/memo-map"
...
export function createRoutes(
  ...
  return Layer.mergeAll(rootApiRoutes, eventApiRoutes, ptyConnectApiRoutes, instanceRoutes, docRoute).pipe(
    Layer.provide([
      errorLayer,
      compressionLayer,
      corsVaryFix,
