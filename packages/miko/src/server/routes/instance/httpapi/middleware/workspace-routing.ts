...
>()("@miko/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@miko/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.MIKO_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.MIKO_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-miko-directory"] || process.cwd()
}
