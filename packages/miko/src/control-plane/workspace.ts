...
import { EventSequenceTable, EventTable } from "@miko-ai/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@miko/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        MIKO_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        MIKO_WORKSPACE_ID: config.id,
        MIKO_EXPERIMENTAL_WORKSPACES: "true",
