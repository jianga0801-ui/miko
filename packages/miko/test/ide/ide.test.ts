...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders MIKO_CALLER", () => {
    process.env["MIKO_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode MIKO_CALLER", () => {
    process.env["MIKO_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown MIKO_CALLER", () => {
    process.env["MIKO_CALLER"] = "unknown"
