  ...
  scout.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "miko-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "miko-glob-reference")
