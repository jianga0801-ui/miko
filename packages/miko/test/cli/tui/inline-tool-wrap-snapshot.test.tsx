...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "MIKO.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/miko/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/miko (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/miko/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/miko/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const MIKO_DB|MIKO_DB|MIKO_DEV|Global\\.Path\\.data|data =" in packages/miko/src (115 matches)',
  },
] as const
