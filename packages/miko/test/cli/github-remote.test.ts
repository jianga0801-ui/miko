...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/miko.git")).toEqual({ owner: "sst", repo: "miko" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/miko")).toEqual({ owner: "sst", repo: "miko" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/miko.git")).toEqual({ owner: "sst", repo: "miko" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/miko")).toEqual({ owner: "sst", repo: "miko" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/miko.git")).toEqual({ owner: "sst", repo: "miko" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/miko")).toEqual({ owner: "sst", repo: "miko" })
})
