...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips miko-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-miko-directory"]).toBeUndefined()
      expect(forwarded["x-miko-workspace"]).toBeUndefined()
