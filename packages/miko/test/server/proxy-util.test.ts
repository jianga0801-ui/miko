...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips miko-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-miko-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-miko-directory")).toBeNull()
      expect(result.get("x-miko-workspace")).toBeNull()
