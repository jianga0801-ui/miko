...
import { ensureProcessMetadata } from "../util/miko-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "miko.client": Flag.MIKO_CLIENT,
      "miko.process_role": processMetadata.processRole,
      "miko.run_id": processMetadata.runID,
