...
import { ProviderPlugins } from "@miko-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@miko-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.options.headers).toEqual({ "HTTP-Referer": "https://miko.dev/", "X-Title": "miko" })
