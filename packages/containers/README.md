...
```
REGISTRY=ghcr.io/jianga0801-ui TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/jianga0801-ui TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/jianga0801-ui/build/bun-node:24.04
```
